...
namespace Workstatic
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider)
        {
            ...
            CreatRole(serviceProvider, "Admin").Wait();
            CreateDefaultUser(serviceProvider, "Admin", "admin@workstatic.com", "Test1.").Wait();
        }

        public async Task CreatRole(IServiceProvider serviceProvider, string roleName)
        {
